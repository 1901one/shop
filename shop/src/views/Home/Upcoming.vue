    ...
    <div class="wrap">
          <div class="fir">
                ...
                <div class="swiper-container">
                        <div class="swiper-wrapper">
                                  ...
                                  <div class="swiper-slide" v-for="(item,index) in list1">
                                        <router-link to="/flims" tag="div">
                                                <img :src="item.img | replaceWH('90.115')" alt="" class="hope">
          ...
          <div class="sec">
                <div v-for="(item,index) in list2">
                      <p class="group-date" v-if="index===0 || index!==0 && item.comingTitle !== list2[index-1].comingTitle">{{item.comingTitle}}</p>
                      <router-link to="/flims" tag="div">
                              <div class="films">
                                  <div class="left">
                                      <img :src="item.img | replaceWH('90.115')" alt="">
                                  </div>
                                  <div class="right">
                                      ...
                                      <div class="box">
                                            ...
                                            <router-link to="/dl"><button class="btn" v-bind:class="{'btnys':item.showst===4}">想看</button></router-link>                            
                                      </div>
